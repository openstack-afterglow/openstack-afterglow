...
```json
{
  ...
  "reviewed_at": "2026-09-25T00:01:37Z",
  "summary": "Recorded 1.25.0 release and DMSLAB Kolla deployment evidence; archived release-five-services-kolla. Palimpsest Hub now a live production service on 8021/18021 via Afterglow BFF. Documentation only."
}
```
