...
<div class="grid grid-cols-2 gap-4 mb-6">
  <div class="bg-surface-base border border-line rounded-xl p-4">
    <div class="text-xs text-ink-2 mb-1">상태</div>
