...
<section class="bg-surface-base border border-line rounded-lg p-5 mb-4">
	...
	{#if showAddListener}
		<div class="mb-4 p-4 bg-surface-sunken/60 border border-line-2 rounded-lg grid grid-cols-1 sm:grid-cols-3 gap-2">
			...
			<button onclick={handleAdd} disabled={saving} class="col-span-2 bg-action-warm hover:bg-action-warm-hover disabled:bg-surface-selected text-ink-0 text-sm px-3 py-2 rounded">생성</button>
