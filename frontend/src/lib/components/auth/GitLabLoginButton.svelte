...
{#if enabled}
  ...
  <button
    ...
    onclick={onClick}
    disabled={loading}
    class="w-full flex items-center justify-center gap-2 bg-[#FC6D26] hover:bg-[#E24329] disabled:bg-surface-selected disabled:text-ink-3 text-action-on-warm font-medium rounded-lg py-2.5 text-sm transition-colors"
  >
