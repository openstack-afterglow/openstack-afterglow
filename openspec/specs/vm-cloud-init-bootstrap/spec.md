# VM Cloud-Init Bootstrap Specification

## Purpose
Define the cloud-init bootstrap contracts for virtual machines, including layer ownership, package rendering, metadata, credentials, and GPU support.
